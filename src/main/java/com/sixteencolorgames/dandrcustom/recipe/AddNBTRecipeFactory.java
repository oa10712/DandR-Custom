package com.sixteencolorgames.dandrcustom.recipe;
...
public class AddNBTRecipeFactory implements IRecipeFactory {
	...
	public IRecipe parse(JsonContext context, JsonObject json) {
		...
		return new AddNBTRecipe(new ResourceLocation(DandrCustomMod.MODID, "addNBT_crafting"), primer,
	...
	public static class AddNBTRecipe extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe>
		...
		public ItemStack getCraftingResult(@Nonnull InventoryCrafting var1) {
			...
			ItemStack itemstack = var1.getStackInRowAndColumn(1, 1);
			NBTTagCompound tag;
